...
class MJ_gmgt_MailChimp
{
     ...
     */
    public function MJ_gmgt_validateApiKey()
    {
    ...
    {
        return $this->MJ_gmgt_makeRequest($method, $args, $timeout);
    }
     ...
     */
    private function MJ_gmgt_makeRequest($method, $args = array(), $timeout = 10)
    {
