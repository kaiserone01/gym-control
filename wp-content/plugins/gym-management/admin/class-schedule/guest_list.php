													...
													<li class="">
														...
														<ul class="dropdown-menu heder-dropdown-menu action_dropdawn" aria-labelledby="dropdownMenuLink">
															...
															<li class="float_left_width_100">
																...
																<a href="?page=gmgt_class&tab=guest_list&action=delete&guest_id=<?php echo esc_attr($retrieved_data->guest_id);?>" class="float_left_width_100 list_delete_btn" onclick="return confirm('<?php esc_html_e('Are you sure you want to delete this record?','gym_mgt');?>');"><i class="fa fa-trash"></i> <?php esc_html_e('Delete','gym_mgt');?></a> 
