					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 ">
						...
						<div class="form-group input">
							...
							<div class="col-md-12 form-control">
								...
								<label class="" for="middle_name"><?php esc_html_e('Middle Name','gym_mgt');?>
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						...
						<div class="form-group input">
							...
							<div class="col-md-12 form-control">
								...
								<input id="password" class="form-control space_validation <?php if(!$edit) echo esc_attr('validate[required,minSize[8],maxSize[12]]');?>" type="password" minlength="8" maxlength="12" name="password" value="" >
							...
							<div class="col-md-8">
								...
								<div class="form-group input margin_bottom_0">
									...
									<div class="col-md-12 form-control">
										...
										<input id="mobile" class="form-control validate[required,custom[phone_number],minSize[6],maxSize[15]] text-input phone_validation" type="text" name="mobile" minlength="6" maxlength="15" value="<?php if($edit){ echo esc_attr($user_info->mobile);}elseif(isset($_POST['mobile'])) echo esc_attr($_POST['mobile']);?>" >
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						...
						<div class="form-group input">
							...
							<div class="col-md-12 form-control">
								...
								<input id="phone" class="form-control validate[custom[phone_number],minSize[6],maxSize[15]] text-input phone_validation" type="text" minlength="6" maxlength="15"   name="phone" value="<?php if($edit){ echo esc_attr($user_info->phone);}elseif(isset($_POST['phone'])) echo esc_attr($_POST['phone']);?>" >
