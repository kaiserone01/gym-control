    ...
    <div class="modal-body border_invoice_page margin_top_15px_rs invoice_model_body float_left_width_100 height_600px"><!---- model body  ----->
        ...
        <div class="main_div float_left_width_100 payment_invoice_popup_main_div">
            ...
            <div class="invoice_width_100 float_left_width_100" border="0">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-5 padding_0 float_left display_grid display_inherit_res margin_bottom_20px rs_main_billed_to">
								...
								<div class="billed_to float_left_width_100 display_flex invoice_address_heading rs_width_billed_to">				
...

                                    {
                                        ...
                                        $memberhsip_status=MJ_gmgt_get_membership_paymentstatus($membership_data->mp_id);	
...

										{
                                            ...
                                            $payment_status=$memberhsip_status;
                ...
                <div class="table-responsive rtl_padding-left_40px rtl_float_left_width_100px">
...

                    {
...

                        {
                            ...
                            if(!empty($selling_data->tax_id)){

                                $tax_name = MJ_gmgt_tax_name_by_tax_id_array_for_invoice(esc_html($selling_data->tax_id));
                                ...
                                <tbody>							
...

                                    {
                                        ...
                                        if($_REQUEST['invoice_type']=='membership_invoice'){
                                            ...
                                            ?>
                                             ...
                                             <tr>
                                                ...
                                                <td width="85%" class="rtl_float_left_label padding_bottom_15px total_heading" align="right"><?php echo esc_attr__('Discount Amount :','gym_mgt');?></td>
                                             ...
                                             <tr>
                                                ...
                                                <td width="85%" class="rtl_float_left_label padding_bottom_15px total_heading" align="right"><?php echo esc_attr__('Tax Amount :','gym_mgt');?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="rtl_width_15px padding_bottom_15px total_value"><?php  echo MJ_gmgt_get_currency_symbol(get_option( 'gmgt_currency_code' ));?><?php echo MJ_gmgt_get_floting_value($due_amount,2); ?></td>
                ...
                <div class="col-md-12 grand_total_main_div total_padding_15px rtl_float_none rtl_margin_top_15px">
                    ...
                    <div class="row rtl_margin_top_15px margin_top_10px_res width_50_res col-md-6 col-sm-6 col-xs-6 print-button pull-left invoice_print_pdf_btn">
                        ...
                        <div class="col-md-2 print_btn_rs width_50_res rtl_margin_top_15px">
                        ...
                        <div class="col-md-3 pdf_btn_rs width_50_res rtl_margin_top_15px">
