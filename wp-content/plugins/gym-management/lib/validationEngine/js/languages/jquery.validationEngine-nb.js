(function($){
    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "* Dette feltet er obligatorisk",
                    "alertTextCheckboxMultiple": "* Vennligst velg et alternativ",
                    "alertTextCheckboxe": "* Denne avmerkingsboksen er obligatorisk",
		...
		"groupRequired": {
                    "regex": "none",
                    "alertText": "* Du må fylle ut ett av følgende felt",
                    "alertTextCheckboxMultiple": "* Vennligst velg et alternativ",
                    "alertTextCheckboxe": "* Denne avmerkingsboksen er obligatorisk"
                },
                "min": {
                    "regex": "none",
                    "alertText": "* Minimumsverdien er "
                },
                "max": {
                    "regex": "none",
                    "alertText": "* Maksimal verdi er "
                },
                "past": {
                    "regex": "none",
                    "alertText": "* Dato før "
                ...
                "fullname": {
                    ...
                    "alertText":"* Må være for- og etternavn"
                },
                "zip": {
                    "regex":/^\d{5}$|^\d{5}-\d{4}$/,
                    "alertText":"* Ugyldig zip-format"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                ...
                "number": {
                    ...
                    "alertText": "* Ugyldig flytende desimaltall"
                },
                "date": {                    
			...
			"func": function (field) {
			 ...
			 "alertText": "* Invalid date, must be in YYYY-MM-DD format"
                ...
                "onlyNumberSp": {
                    "regex": /^[0-9\ ]+$/,
                    "alertText": "* Kun nummer"
                },
                "onlyNumberSp_custom": {
                    "regex": /^[0-9\ ]+$/,
                    "alertText": "* Verdien må være større enn eller lik 0"
                },
                "onlyLetterSp": {
				...
				"onlyLetterAccentSp":{
                    "regex": /^[a-z\u00C0-\u017F\ ]+$/i,
                    "alertText": "* Bare bokstaver (aksenter tillatt)"
                },
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
				...
				"onlyLetter_specialcharacter": 
				{
                    ...
                    "alertText": "* Kun bokstaver og '_,'.'^-' tegn tillatt"
                },
				...
				{
				"regex": /^[0-9a-zA-Z\ \_\,\`\.\:\[\]\'\^\()]+$/,
                    "alertText": "* Kun bokstaver, tall og '_,'.'^' Tegn tillatt"
                },
				...
				{
                    "regex": /^[0-9a-zA-Z\_\.\-\@]+$/,
                    "alertText": "* Kun bokstaver, tall og '_.-@'-tegn er tillatt"
                }, 
				//6)Phone Number
				"phone_number": 
				{
