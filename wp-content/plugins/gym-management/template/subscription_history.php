...
if(isset($_POST['start_subscription_for_exsting_member']))
...

{
	...
	$payment_type="start_subscription_for_exsting_member";
...

{
...

	{
		...
		<div id="message" class="alert_msg alert alert-success alert-dismissible " role="alert">
			...
			<?php esc_html_e('Subscription Start successfully.','gym_mgt');?>
...

							{
								...
								{ 
									...
									<tr>
										...
										<td class="totalamount"><?php  echo MJ_gmgt_get_currency_symbol(get_option( 'gmgt_currency_code' )); ?><?php echo number_format(esc_html($retrieved_data->paid_amount),2);?> <i class="fa fa-info-circle fa_information_bg" data-toggle="tooltip" data-placement="top" title="<?php _e('Paid Amount','gym_mgt');?>" ></td>
										...
										<td class="paymentdate"><?php echo MJ_gmgt_getdate_in_input_box(esc_html($retrieved_data->start_date));?> <i class="fa fa-info-circle fa_information_bg" data-toggle="tooltip" data-placement="top" title="<?php _e('Membership Start Date','gym_mgt');?>" ></td>



										<td class="paymentdate"><?php echo MJ_gmgt_getdate_in_input_box(esc_html($retrieved_data->end_date));?> <i class="fa fa-info-circle fa_information_bg" data-toggle="tooltip" data-placement="top" title="<?php _e('Membership End Date','gym_mgt');?>" ></td>
										...
										<td class="paymentdate">
											...
											$status = MJ_gmgt_get_membership_paymentstatus($retrieved_data->mp_id);
												...
												<ul class="" style="margin-bottom: 0px !important;">
													...
													<li class="">
														...
														<ul class="dropdown-menu heder-dropdown-menu action_dropdawn" aria-labelledby="dropdownMenuLink">
															...
															{	
																...
																{ 
																	...
																	<li class="float_left_width_100">
																		...
																		<a href="" class="show-payment-popup float_left_width_100" idtest="<?php echo esc_attr($retrieved_data->mp_id); ?>" due_amount="<?php echo esc_attr($due_amount); ?>"  view_type="subscription_membership_payment" ><i class="fa fa-credit-card" aria-hidden="true"></i> <?php esc_html_e('Pay','gym_mgt');?></a>
															...
															$check_membership_recurring_option= MJ_gmgt_check_membership_recurring_option($retrieved_data->membership_id);



															$membership_data=$obj_membership->MJ_gmgt_get_single_membership($retrieved_data->membership_id);



															$stripe_plan_id=$membership_data->stripe_plan_id;



															$subscription_id=get_user_meta($retrieved_data->member_id,'subscription_id',true);



															if($gym_recurring_enable == "yes" && !empty($stripe_plan_id) && $check_membership_recurring_option == "yes" && empty($subscription_id) && $membershistatus == "Expired")
...

															{
																...
																<li class="float_left_width_100">
																	...
																	<a href="" class="new_subscription_start float_left_width_100" stripe_plan_id="<?php echo $stripe_plan_id; ?>" membership_id="<?php echo $retrieved_data->membership_id; ?>" member_id="<?php echo esc_attr($retrieved_data->member_id);?>" ><i class="fa fa-credit-card" aria-hidden="true"></i> <?php esc_html_e('Start Subscription','gym_mgt');?></a>
...

															{
																...
																<li class="float_left_width_100">
																	...
																	<a href="?dashboard=user&page_action=web_view_hide&page=subscription_history&tab=view_invoice&idtest=<?php echo $retrieved_data->mp_id; ?>&invoice_type=membership_invoice" class=" float_left_width_100"><i class="fa fa-eye" aria-hidden="true"></i> <?php esc_html_e('View Invoice', 'gym_mgt' ) ;?></a>
															...
															{ ?>
																 ...
																 <li class="float_left_width_100">
																	...
																	<a href="?dashboard=user&page=subscription_history&tab=view_invoice&idtest=<?php echo $retrieved_data->mp_id; ?>&invoice_type=membership_invoice" class=" float_left_width_100"><i class="fa fa-eye" aria-hidden="true"></i> <?php esc_html_e('View Invoice', 'gym_mgt' ) ;?></a>
					...
					<div class="main_div float_left_width_100 payment_invoice_popup_main_div">
						...
						<div class="invoice_width_100 float_left_width_100" border="0">
							...
							<div class="col-md-12  grand_total_main_div total_padding_15px rtl_float_none margin_top_15px">
								...
								<div class="row rtl_margin_top_15px margin_top_10px_res width_50_res col-md-6 col-sm-6 col-xs-6 print-button pull-left invoice_print_pdf_btn">
