...
if($color_setting==""){$color_setting='#fd7e14';}
$color_setting=str_replace('#','',$color_setting);

?>
<style>
.cbp-l-filters-list .cbp-filter-item {
    border: 1px solid #<?php echo esc_html($color_setting); ?>!important;;
}

.done-training{ background:#<?php echo esc_html($color_setting); ?>!important; color:white !important;}

#training_done{ color:#<?php echo esc_html($color_setting); ?>!important;
 }
button,
