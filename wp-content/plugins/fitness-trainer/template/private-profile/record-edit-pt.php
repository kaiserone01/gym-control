								...
								<form action="" id="edit_post" name="edit_post"  method="POST" role="form">
									...
									<?php
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" class="col-sm-8" name="<?php echo esc_html($field_key);?>" id="<?php echo esc_html($field_key);?>" value="<?php echo get_post_meta($curr_post_id,$field_key,true); ?>" placeholder="<?php echo esc_html_e('Enter', 'epfitness'); ?> <?php echo esc_html_e($field_value, 'epfitness'); ?>">
											</div>
										</div>
										<?php
										}
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											...
											<button type="button" onclick="iv_update_post();"  class="btn green-haze"><?php esc_html_e('Update Record','epfitness'); ?></button>
										</div>
									</div>
								</form>
							</div>
