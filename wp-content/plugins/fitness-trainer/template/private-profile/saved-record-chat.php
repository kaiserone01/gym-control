...
?>
<div class="row save_record">
	<div class="col-md-12">
		<form id="chartfor" name="chartfor" method="post" >
			<input type="hidden" value="<?php echo esc_html($search_user);?>" name="report_for_user_chart" id="report_for_user_chart">
