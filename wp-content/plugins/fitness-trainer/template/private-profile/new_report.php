...
<div class="profile-content">
	<div class="portlet-title tabbable-line clearfix">
		<div class="caption caption-md">
				  <span class="caption-subject"><?php esc_html_e('New Report','epfitness');?>
					 </span>
		</div>
	</div>
		<form action="" id="add_report1" name="add_report1"  method="POST" role="form">
			<?php
				...
				<div class="form-group row">
					<label for="text" class="col-sm-3 col-form-label"><?php esc_html_e('Report For','epfitness'); ?></label>
					<div class="col-sm-9">
							...
							$user_query = new WP_User_Query( $args );
							 if ( ! empty( $user_query->results ) ) {
								foreach ( $user_query->results as $user ) {
									...
									?>
									<option value="<?php echo esc_html($user->ID); ?>" <?php echo esc_html($selected); ?> > <?php echo esc_html($user->ID); ?> | <?php echo esc_html($user->display_name); ?> | <?php echo esc_html($user->user_email); ?></option>
								<?php
								}
							}
							?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<div class="col wid1-3 hLay input-append date" id="dp1" data-date="12-Feb-2015" >
						<input class="input-medium col-sm-8 " id="datepicker4" name='report_date' size="16" type="text" value="" >
			...
			<?php
				...
				foreach ( $default_fields as $field_key => $field_value ) {	?>
					<div class="form-group row">
						...
						<div class="col-sm-9">
								<textarea class=" col-sm-12 " name ="<?php echo esc_html($field_key);?>" rows="3"></textarea>
						</div>
					</div>
					<?php
					$i++;
