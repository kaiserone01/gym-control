    ...
    <div id="js-grid-blog-posts" class="cbp">
			<?php
				...
				<div class="cbp-item <?php echo esc_html($cat_slug); ?> ">
					<a href="<?php echo get_permalink($post_content->ID); ?><?php // echo'?&fitprofile=post&id='.$post_content->ID;?>" target="_blank" class="cbp-caption">
					...
					<a href="<?php echo get_permalink($post_content->ID); ?><?php echo'?&fitprofile=post&id='.$post_content->ID;?>" target="_blank" class="cbp-l-grid-blog-title"><?php echo esc_html($post_content->post_title);?> </a>
